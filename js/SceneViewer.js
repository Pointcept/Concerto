(function () {
    ...
    function initViewers() {
        ...
        pcdViewer = new SceneViewer("canvas-pcd", "https://raw.githubusercontent.com/Pointcept/Assets/main/concerto/demos/ply/1/pcd.ply", manager);
        pcaViewer = new SceneViewer("canvas-pca", "https://raw.githubusercontent.com/Pointcept/Assets/main/concerto/demos/ply/1/pca.ply", manager);
    ...
    window.loadModelPair = function(name) {
        // const pcdPath = `ply/${name}/pcd.ply`;
        // const pcaPath = `ply/${name}/pca.ply`;
        const pcdPath = `https://raw.githubusercontent.com/Pointcept/Assets/main/concerto/demos/ply/${name}/pcd.ply`;
        const pcaPath = `https://raw.githubusercontent.com/Pointcept/Assets/main/concerto/demos/ply/${name}/pca.ply`;
